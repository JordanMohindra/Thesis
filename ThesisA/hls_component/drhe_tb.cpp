...
int main() {
    std::cout << "==========================================================" << std::endl;
    std::cout << " DRHE Compression & Decompression Vitis HLS Testbench     " << std::endl;
    ...
    for (uint32_t frame = 0; frame < nFrames; frame++) {
        ...
        // ---- 2b. Run Compression ----
        drhe_compress(compress_in, compress_out, nSamples, nRamps, nRX);
        ...
        drhe_decompress(compress_out, decompress_out, nSamples, nRamps, nRX);
